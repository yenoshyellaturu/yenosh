...
sns.catplot(x='Bet_Type_Preference',y='Age',kind='box',data=df)
...
#IQR for all numerical columns
q1=df['Average_Amount_of_Bonuses_Received'].quantile(0.25)
q3=df['Average_Amount_of_Bonuses_Received'].quantile(0.75)
iqr=q3-q1
print(q1)
print(q3)
print(iqr)
